...
float CurieIMUClass::getMagRate()       //Added for BMM150 Support
{
    ...
    switch(BMI160Class::getMagRate()) {
        case BMI160_MAG_RATE_25_32HZ:
            rate = 25/32;
            break;

        case BMI160_MAG_RATE_25_16HZ:
            rate = 25/16;
            break;

        case BMI160_MAG_RATE_25_8HZ:
            rate = 25/8;
            break;

        case BMI160_MAG_RATE_25_4HZ:
            rate = 25/4;
            break;

        case BMI160_MAG_RATE_25_2HZ:
            rate = 25/2;
            break;

        case BMI160_MAG_RATE_25HZ:
            rate = 25;
            break;

        case BMI160_MAG_RATE_50HZ:
            rate = 50;
            break;

        case BMI160_MAG_RATE_100HZ:
            rate = 100;
            break;

        case BMI160_MAG_RATE_200HZ:
            rate = 200;
            break;

        case BMI160_MAG_RATE_400HZ:
            rate = 400;
            break;

        case BMI160_MAG_RATE_800HZ:
        default:
            rate = 800;
            break;
    }
...
void CurieIMUClass::setMagRate(float rate)    //Added for BMM150 Support
{
    ...
    if (rate <= 25/32) {
        bmiRate = BMI160_MAG_RATE_25_32HZ;
    } else if (rate <= 25/16) {
        bmiRate = BMI160_MAG_RATE_25_16HZ;
    } else if (rate <= 25/8) {
        bmiRate = BMI160_MAG_RATE_25_8HZ;
    } else if (rate <= 25/4) {
        bmiRate = BMI160_MAG_RATE_25_4HZ;
    } else if (rate <= 25/2) {
        bmiRate = BMI160_MAG_RATE_25_2HZ;
    } else if (rate <= 25) {
        bmiRate = BMI160_MAG_RATE_25HZ;
    } else if (rate <= 50) {
        bmiRate = BMI160_MAG_RATE_50HZ;
    } else if (rate <= 100) {
        bmiRate = BMI160_MAG_RATE_100HZ;
    } else if (rate <= 200) {
        bmiRate = BMI160_MAG_RATE_200HZ;
    } else if (rate <= 400) {
        bmiRate = BMI160_MAG_RATE_400HZ;
    } else {
        bmiRate = BMI160_MAG_RATE_800HZ;
    }

    BMI160Class::setMagRate(bmiRate);
}
